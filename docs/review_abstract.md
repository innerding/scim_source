...
sowie ein Farb-/Schwellenmodell der Auslastung. Aus dieser Representation schnürt eine
...
empfangen). Ein Regelkreis im Fünf-Minuten-Takt (Signalimpuls → Comfort → Route) passt die
angezeigte und gewählte Route fortlaufend an die jeweils anliegende Auslastung an.
...
Single-Source-of-Truth-Bibliothek (*shell-kit*) sowie edge-lokale Berechnung bei minimaler
Datenhaltung.
