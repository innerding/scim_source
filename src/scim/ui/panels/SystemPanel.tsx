...
const ARCHITEKTUR_ARTEFAKTE = [
  ...
  { id: 'scim2',    label: 'SCIM2-Focusmodel',          art: 'Build-Test',         desc: 'Darstellung einer visuell steuerbaren Update-Maschine mit 33 Quellcode-Modulen — Komplexität nicht versteckt, sondern sichtbar und begreifbar gemacht. Erster Build-Test mit Claude (Anthropic): methodisch noch unstrukturiert, iterativ ohne klare Einstiegsprompts. Das Ergebnis zeigte das Potential, offenbarte aber: KI-gestützte Entwicklung braucht präzise Architektur als Führung.' },
