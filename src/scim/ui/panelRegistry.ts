...
export const PANEL_REGISTRY: PanelDescriptor[] = [
  ...
  },
  {
    ...
    order: 6,
    icon: '〜',
    shortDescription: 'Telco-Signal-Klassifikation',
    helpText: 'Klassifiziert jeden Telco-Signalpunkt als flow, accumulation oder ambiguous. Operator-Zonen können Punkte direkt als Aufenthaltsbereich erzwingen.',
    dependsOn: ['P04', 'P05'],
