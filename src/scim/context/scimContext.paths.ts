export type ScimPanelId =
  ...
  | 'panel_5_operator_zones'
  | 'panel_6_signal_interpretation'
...
export const PANEL_WRITE_MAP: Record<ScimPanelId, ScimContextPath[]> = {
  ...
  panel_5_operator_zones: ['context.operator_zones'],
  panel_6_signal_interpretation: ['context.signal_interpretation'],
  panel_7_boundary_extraction: ['context.boundary', 'context.extracted_data'],
  panel_8_graph_basislayer: [
    'context.scim_context',
    'context.graph',
    'context.basis_layer',
  ...
  panel_11_sensus_core_package_builder: ['context.sensus_core_package'],
  panel_12_sensus_core_local: ['context.local_user_context', 'context.view_state'],
  panel_13_leaflet_effect_check: ['context.leaflet_effect_check'],
  panel_14_release_export: ['context.release', 'context.status'],
};

// Panel 7 also owns representation_id, handled separately in update logic
export const PANEL_7_REPRESENTATION_ID_WRITE = true;
