...
export const PANEL_WRITE_MAP: Record<ScimPanelId, ScimContextPath[]> = {
  ...
  panel_6_boundary_extraction: ['context.boundary', 'context.extracted_data'],
  panel_7_graph_basislayer: [
    'context.scim_context',
    'context.graph',
    'context.basis_layer',
  ...
  panel_10_sensus_core_package_builder: ['context.sensus_core_package'],
  panel_11_sensus_core_local: ['context.local_user_context', 'context.view_state'],
  panel_12_leaflet_effect_check: ['context.leaflet_effect_check'],
  panel_13_release_export: ['context.release', 'context.status'],
};

// Panel 6 also owns representation_id, handled separately in update logic
export const PANEL_6_REPRESENTATION_ID_WRITE = true;
