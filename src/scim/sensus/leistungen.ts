...
export const LEISTUNGEN: Kennzahl[] = [
  ...
  { label: 'Paket Lichtenberg', wert: '~199 KB Erstlieferung', detail: 'gzip (live gemessen) — Shell ~147 (JS 139 + CSS 8) + Origin 49,5 (648 Segmente, ohne px-Bilder) + Anthem ~2,2 KB (volatil ~2–3) · laufend (Bestandsnutzer) nur Anthem ~2,2 KB / 5 Min' },
];
