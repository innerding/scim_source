...
// Rein (kein Leaflet/DOM), damit Sim + Tests sie ohne UI nutzen können.
//
// Drei DURCHGEHENDE Palette-Modelle (§2a, nie geschnitten) — wählbar in P04
// „Grund-Spektrum". Default: green_violet (p10-Farben, aber stetig).
...
const GREEN_VIOLET: Stops = [
  { at: 0.00, color: [46, 204, 64] },    // #2ecc40 — grün
  { at: 0.25, color: [168, 224, 0] },    // #a8e000 — gelbgrün
  { at: 0.50, color: [255, 212, 0] },    // #ffd400 — gelb
  { at: 0.70, color: [255, 123, 0] },    // #ff7b00 — orange
  { at: 0.85, color: [255, 45, 45] },    // #ff2d2d — rot
  { at: 1.00, color: [142, 36, 170] },   // #8e24aa — violett
];

// Dezent / niedrig gesättigt.
const CALM: Stops = [
  { at: 0.00, color: [74, 111, 165] },   // #4a6fa5 — gedämpftes blau
  { at: 0.50, color: [126, 138, 160] },  // #7e8aa0 — graublau
  { at: 1.00, color: [176, 106, 122] },  // #b06a7a — gedämpftes rosé
];
...
// Parametrisierter Colorist (A2 + #1). Beugt die Last STETIG und mappt sie auf
// die gewählte durchgehende Palette:
...
// System-Normalisierung (A3) darauf aufsetzen kann.
